...
TEST_SBATCH_SLEEP = Path(__file__).parent / \
    "test_sbatch" / "test_sbatch_sleep.sbatch"
...
class TestBBWrapper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.bb_wrapper = BBWrapper(component_name="component_1",
    ...
    def test_on_interrupt(self):
        ...
        job_id = self.bb_wrapper.component.submit_sbatch(self.bb_wrapper.sbatch_file,
                                                         wait=False)
    ...
    def test_parse_job_elapsed_time(self):
        ...
        self.assertGreater(self.bb_wrapper.parse_job_elapsed_time(job_id),
                           0)
        self.assertLess(self.bb_wrapper.parse_job_elapsed_time(job_id),
                        10)
    ...
    def test_compute_separate_thread(self):
        ...
        while not future.done():
            ...
            self.assertGreater(self.bb_wrapper.parse_job_elapsed_time(running_job_id),
                               0)
            # Scancel the job

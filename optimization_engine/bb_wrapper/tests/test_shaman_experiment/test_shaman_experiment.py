...
CONFIG_ASYNC = Path(__file__).parent / "test_config" / \
    "pruning.yaml"
...
COMPONENT_CONFIG = Path(__file__).parent / "test_config" / \
...
class TestSHAManExperiment(unittest.TestCase):
    ...
    def test_launch_experiment(self, mock_summarize, mock_optimize, mock_default, mock_post):
...
class TestSHAManAPI(unittest.TestCase):
    ...
    def test_start_experiment_dict_vanilla(self):
        ...
        expected_dict = {
            ...
            "experiment_parameters": {'heuristic': 'genetic_algorithm',
    ...
    def test_start_experiment_dict_noise_reduction(self):
        ...
        expected_dict = {
            ...
            "experiment_parameters": {'heuristic': 'genetic_algorithm',
                                      ...
                                      'mutation_rate': 0.4,
                                      'elitism': False},
            "noise_reduction_strategy": {'resampling_policy': 'simple_resampling',
                                         'nbr_resamples': 3,
    ...
    def test_best_time(self):
        ...
        se = SHAManExperiment(component_name='component_1',
                              ...
                              experiment_name="test_experiment",
                              configuration_file=CONFIG)
        se.bb_optimizer.history = {"fitness": np.array([2, 2, 3]),
                                   "parameters": np.array([[1, 2], [2, 2], [1, 2]])}
    ...
    def test_end_dict(self, mock_parse, mock_submit):
        ...
        se.bb_optimizer.history = fake_history
        expected_dict = {'averaged_execution_time': [2.0, 2.0, 3.0],
                         ...
                         'elapsed_time': 0,
                         'default_run': {'execution_time': 10.0, 'job_id': 10, 'parameters': {'param_1': 1, 'param_2': '/home/'}},
                         'average_noise': 0.25,

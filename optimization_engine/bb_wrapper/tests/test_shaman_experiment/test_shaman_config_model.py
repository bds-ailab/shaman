...
from bb_wrapper.shaman_config_model import SHAManConfig, PruningParameters
...
class TestSHAManModelVanilla(unittest.TestCase):
    ...
    def test_load_config_vanilla_component_1(self):
        ...
        self.assertEqual(shaman_config.component_parameter_names,
                         ["param_1", "param_2"])
...
class TestSHAManNoiseReduction(unittest.TestCase):
    ...
    def test_noise_reduction(self):
        ...
        self.assertDictEqual(shaman_config.noise_reduction,
                             expected_noise_reduction_parameters)

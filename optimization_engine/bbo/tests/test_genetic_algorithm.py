...
from bbo.heuristics.genetic_algorithm.selections import _select_by_fitness, _remove_from_history, \
    _compute_weighted_probability, probabilistic_pick, tournament_pick, _sort_by_fitness
...
class TestSelectionMethods(unittest.TestCase):
    ...
    def test_sort_by_fitness(self):
        ...
        expected_output = (np.array([[3, 4],
                                     ...
                                     [1, 2],
                                     [3, 2],
                                     [1, 2]]), np.array([10, 14, 20, 30, 32]))
        assert_array_equal(sorted_values[0], expected_output[0], "Sorted parameters are "
                                                                 "correct.")
        assert_array_equal(sorted_values[1], expected_output[1], "Sorted fitness is correct.")
    ...
    def test_select_by_fitness(self):
        ...
        """
        matingpool_size = 2
        selected_parameters, selected_fitness = _select_by_fitness(FAKE_HISTORY, matingpool_size)
        assert_array_equal(selected_parameters, np.array([[4, 3], [1, 3]]), "Selecting by fitness "
                                                                            "did not work "
                                                                            "properly.")
        assert_array_equal(selected_fitness, np.array([2, 4]), "Selecting by fitness"
    ...
    def test_remove_from_history(self):
        ...
        filtered_parameters, filtered_fitness = _remove_from_history(FAKE_HISTORY["parameters"],
                                                                     FAKE_HISTORY["fitness"],
                                                                     filtered_parameter)
        assert_array_equal(filtered_parameters, expected_parameters,
                           "Parameter filtering did not work properly.")
        assert_array_equal(filtered_fitness, expected_fitness, "Fitness filtering did not work "
                                                               "properly.")
    ...
    def test_weighted_fitness(self):
        ...
        expected_weighted_fitness = np.array([0.1834061, 0.1834061, 0.1222707, 
                                              0.3668122, 0.0917031, 0.0524017])
        assert_almost_equal(expected_weighted_fitness, _compute_weighted_probability(test_fitness))
    ...
    def test_probabilistic_pick_no_elitism(self):
        ...
        assert_array_equal(expected_pick, real_pick, "Expected and real pick do not match when "
...
class TestCrossOverMethods(unittest.TestCase):
    ...
    def test_single_point_crossover(self):
        ...
        assert_array_equal(real_child, expected_child, "Single point crossover did not perform "
                                                       "as expected.")
    ...
    def test_double_point_crossover(self):
        ...
        assert_array_equal(real_child, expected_child, "Double point crossover did not perform "
                                                       "as expected.")
...
class TestMutationMethods(unittest.TestCase):
    ...
    def test_mutation_next_neighbor(self):
        ...
        assert_array_equal(mutated_chromosome, expected_chromosome, "Mutation did not behave as "
                                                                    "expected.")
...
class TestGeneticAlgorithms(unittest.TestCase):
    ...
    def test_class_initialization(self):
        ...
        """
        GeneticAlgorithm(selection_method=tournament_pick,
                         pool_size=2,
    ...
    def test_next_neighbor_no_mutation(self):
        ...
        genetic_algorithm = GeneticAlgorithm(selection_method=tournament_pick,
                                             crossover_method=single_point_crossover,
                                             mutation_method=mutate_chromosome_to_neighbor,
                                             mutation_rate=0,
                                             pool_size=5)
        ...
        assert_array_equal(next_parameter, expected_next_parameter, "Selection of next parameter "

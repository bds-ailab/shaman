...
import unittest
import numpy as np
from bbo.noise_reduction.fitness_transformation import FitnessTransformation, SimpleFitnessTransformation
...
class TestSimpleFitnessTransformation(unittest.TestCase):
    ...
    def test_simple_fitness_transformation_mean(self):
        ...
        history = {"fitness": [2, 3, 4, 1], "parameters": np.array(
            [[1, 2], [1, 2], [3, 4], [3, 4]]), "truncated": [False, False, False, False]}

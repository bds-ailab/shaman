...
from ..models import Experiment, WebSocketExperiment, DetailedExperiment, IntermediateResult, FinalResult, Message, InitExperiment, ExperimentForm
...
router = APIRouter(on_startup=[connect_shaman_db],
                   on_shutdown=[close_shaman_db])

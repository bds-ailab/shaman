...
@router.get(
    "/",
    summary="Get the data associated with the components, with the right format for SHAMAn.",
    description="List the different available components, with the right format for SHAMAn.",

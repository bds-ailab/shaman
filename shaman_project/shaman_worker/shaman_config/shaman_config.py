...
class ShamanSettings(BaseSettings):
    ...
    directory: Path = Path.home() / ".shaman-worker"
...
class ShamanConfig:
    ...
    def __init__(self, default_file, output_file):
        ...
        """
        # TODO: You should support Path object eveywhere you manipulate paths
        # and not rely on strings anymore.
        if isinstance(default_file, Path):
    ...
    def build_configuration(self, post_data):
        ...
        self.update_section("PRUNING_STRATEGY", config_dicts["PRUNING_STRATEGY"])
